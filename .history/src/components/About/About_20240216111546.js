        ...
        <div className="about-details">
          ...
          <Fade right>
            <p className="description">
              Hello, my name is Oladunjoye Opeyemi. 
              I'm a full-stack developer 
              passionate about creating intuitive 
              user interfaces that provide
              an exceptional user experience.
              I pay great attention to detail 
              ensuring that the websites or applications
              I develop are responsive
              visually appealing and accessible.
              I can design efficient database
              structures, write optimized queries
              and integrate APIs to enable
